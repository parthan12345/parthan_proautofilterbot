...
async def start(bot, update):
    ...
    if file_uid:
        ...
        if file_type == "document":
            ...
            await bot.send_document(
                ...
                document = file_id,
                caption = f"{file_name} \n ɢʀᴏᴜᴘ  ➧  @MovieHUB_Chat_Group \n ✯ ━━━━━━ ✧ ━━━━━━ ✯ ɢʀᴏᴜᴘ  ➧ @MH_Chat_Group \n ᴄʜᴀɴɴᴇʟ ➧ @MovieHUB_Update_Channel \n ᴄʜᴀɴɴᴇʟ ➧ @MH_Links_Channel \n \n ♻️𝙅𝙊𝙄𝙉 :- ★ @MovieHUB_Chat_Group ★ \n \n ❣️ ʝσιи  🎗 ѕнαяє 🎗 ѕυρρσят ❣️",
                parse_mode="html",
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton
                                (
                                    '🔊 Our Group 🔊', url="https://t.me/MovieHUB_Chat_Group"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/MovieHUB_Chat_Group"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('📥 JOIN US  📥', url='https://t.me/MovieHUB_Chat_Group')
    ]]
...
async def about(bot, update):
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🍂 create bot like me 🍂', url='https://t.me/MovieHUB_Chat_Group')
    ],[
